...
function(EMBED_LLVM OUTPUT_FILE)
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_CXX_COMPILER} ${FLAGS} -c -emit-llvm -DSOURCE_PATH_SIZE -I${CMAKE_CURRENT_SOURCE_DIR} -I${PROJECT_SOURCE_DIR}/third_party/sql-parser/src -I${PROJECT_SOURCE_DIR}/third_party/json -o ${LLVM_BUNDLE_FILE} ${CPP_BUNDLE_FILE}
