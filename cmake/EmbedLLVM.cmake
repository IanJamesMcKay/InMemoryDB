...
function(EMBED_LLVM OUTPUT_FILE SYMBOL_NAME)
    ...
    # It is important to not optimize here - otherwise `opt` will perform Dead Code Elimination and everything goes
    # straight to hell (https://github.com/hyrise/hyrise/pull/933)
    set(FLAGS -std=c++17 -O0 -fwhole-program-vtables -flto ${CMAKE_CXX_FLAGS})
    add_custom_command(
