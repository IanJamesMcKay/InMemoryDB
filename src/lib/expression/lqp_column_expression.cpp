...
std::shared_ptr<AbstractExpression2> LQPColumnExpression::deep_copy() const {
...
bool LQPColumnExpression::_shallow_equals(const AbstractExpression2& expression) const {
